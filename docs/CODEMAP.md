...
sequenceDiagram
    ...
    rect rgba(83, 168, 182, 0.15)
        Note right of CLI: I/O Phase
    ...
    rect rgba(245, 180, 97, 0.15)
        Note right of CLI: Eigendecomposition Phase
    ...
    rect rgba(233, 69, 96, 0.15)
        Note right of CLI: Association Phase (per SNP chunk)
