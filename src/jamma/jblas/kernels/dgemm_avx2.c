/**
 * dgemm_avx2.c — AVX2/FMA DGEMM microkernel for jblas.
 *
 * Implements the 6x8 microkernel jblas_dgemm_micro_avx2.  This file must be
 ...
 *
 * MR=6, NR=8 are the blocking parameters set by jblas_init() in platform.c
 * when AVX2 is detected; they are read from the JBLAS_MR / JBLAS_NR globals
...
/**
 * jblas_dgemm_micro_avx2 — AVX2+FMA 6x8 DGEMM microkernel.
 *
