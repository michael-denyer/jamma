/**
 * dgemm_neon.c — NEON (AArch64) DGEMM microkernel for jlinalg.
 *
 * Implements the 8x4 microkernel jlinalg_dgemm_micro_neon.  Compiled without
 ...
 *
 * MR=8, NR=4 are the blocking parameters set by jlinalg_init() in platform.c
...
/**
 * jlinalg_dgemm_micro_neon — NEON 8x4 DGEMM microkernel.
 *
    ...
    double * restrict C, npy_intp ldc)
{
    ...
    for (int r = 0; r < 8; r++) {
       ...
       jlinalg_dgemm_micro_neon inside an __aarch64__ guard. */
