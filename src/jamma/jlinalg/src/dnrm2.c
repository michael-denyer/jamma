 ...
 *
 * Implements:
 *   jlinalg_dnrm2_generic — Blue algorithm, fully portable
 *   jlinalg_dnrm2_avx2    — dispatches to generic (SIMD dnrm2 not yet optimised)
 *
...
double jlinalg_dnrm2_avx2(
        ...
        const double *x, int incx)
{
    return jlinalg_dnrm2_generic(n, x, incx);
}
