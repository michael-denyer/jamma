"""Tests for audit findings: numerical guards, parameter validation, and edge cases.

Covers critical test gaps identified in the codebase audit:
- T1: _safe_sqrt boundary behavior
- T2: P_yy clamping in log-likelihood functions
- T3: Over-parameterization guard in _build_covariate_matrix
