...
def test_general_ncvt_abi_version():
    """C-GEN-07: ABI version is 10 for fused Score/LRT support."""
...
@pytest.mark.tier0
def test_abi_version_10():
    """ABI_VERSION is 10 after fused Score/LRT addition."""
    if not _C_ACCEL_AVAILABLE:
...
def test_runner_fused_score_dispatch():
    ...
    # SoA split path (disable fused Score)
    with (
...
def test_runner_fused_lrt_dispatch():
    ...
    # SoA split path (disable fused LRT)
    with (
