...
@pytest.mark.xfail(strict=True, reason="temp_dir_beside returns an unscoped str")
def test_temp_dir_removed_with_untracked_contents_on_exit(tmp_path: Path) -> None:
    ...
    with temp_dir_beside(target, prefix=".jamma_mtest_") as tmp_dir:  # type: ignore[bad-context-manager]
